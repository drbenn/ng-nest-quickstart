...
export enum AuthMessages {
  ...
  STANDARD_PASSWORD_RESET_REQUEST_FAILED = 'standard password reset request failed: user profile with provided email as standard email/password login not found. email not sent to user for password reset.',
